...
const baseApiUrl = "http://192.168.1.171:6001/aitools/wellness/v2/aitools/wellness/v2";
...
const SoulProfilePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`http://192.168.1.171:6001/aitools/wellness/v2/users/profile`, { method: "POST", body: fd });
