...
const DailyReport: React.FC = () => {
    ...
    const fetchWelcome = async () => {
      try {
        const res = await fetch(
          `http://192.168.1.171:6001/aitools/wellness/v2/welcome/welcome`
        );
  ...
  const sendMessage = async (textArg?: string) => {
    ...
    if (conversationActive) {
      ...
      try {
        ...
        const res = await fetch(`http://192.168.1.171:6001/aitools/wellness/v2/welcome/process_message`, {
          method: "POST",
          body: form,
        });
  ...
  const generateReport = async (finalAnswers?: string[]) => {
    try {
      ...
      const res = await fetch(`http://192.168.1.171:6001/aitools/wellness/v2/welcome/generate_report`, {
        method: "POST",
