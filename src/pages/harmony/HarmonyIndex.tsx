...
const HarmonyIndex: React.FC = () => {
  ...
  return (
    ...
    />
      ...
      {step === 1 && (
        <div
          className="d-flex flex-column min-vh-100 min-vw-100 position-relative"
          style={{ backgroundColor: "rgb(255, 255, 255)" }}
        >
          {/* Back button */}
          <div
            className="position-absolute top-0 start-0 w-100"
            style={{ zIndex: 10, padding: "15px 20px" }}
          >
            <button
          ...
          >
            <h3
              ...
              style={{ fontSize: "clamp(1.5rem, 4vw, 1.8rem)", color: "#000" }}
            >
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <SoulProfileDateField
                ...
                inputClassName={`form-control tarot-input ${formData.dob ? "has-value" : ""}`}
                maxIsoDate={today}
              />
