...
const AiChat: React.FC = () => {
    ...
    const fetchSessions = async () => {
        ...
        try {
            const response = await fetch(`${baseApiUrl}/aitools/wellness/v2/chat/sessions/?user_id=${userId}`);
    ...
    const loadConversation = async (sessionId: number | string) => {
        ...
        try {
            const response = await fetch(`${baseApiUrl}/aitools/wellness/v2/chat/conversation/${sessionId}`);
            const data = await response.json();
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (!currentSessionId) {
                ...
                const initResponse = await fetch(`${baseApiUrl}/aitools/wellness/v2/chat/spiritual/${userId}`, {
                    method: 'POST',
            ...
            const response = await fetch(`${baseApiUrl}/aitools/wellness/v2/chat/spiritual/${userId}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded', },
