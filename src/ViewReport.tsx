...
const ViewReport = () => {
  ...
  const baseApiUrl =
    "http://eros-eternal.runai-project-immerso-innnovation-venture-pvt.inferencing.shakticloud.ai/api/v1/reports/individual_report/";
  // const baseApiUrl =
  //   "http://192.168.18.5:7001/api/v1/reports/individual_report/";
  ...
  const getDisplayTitle = () => {
    ...
    const reportType =
      location.state?.reportType || reportData?.report_type || "";
    return reportType
      .split("_")
  ...
  // Check if report type matches one in reportCards
  const isReportTypeMatch = reportCards.some(
    (card) => card.reportType === reportData?.report_type
  );

  // Show button only if report type matches AND report date ≠ today
  const shouldShowContinueChat =
    isReportTypeMatch && reportDateStr !== currentDateStr;
  return (
    <div
        ...
        <div className="row justify-content-center">
          <div className="col-12 col-md-10 col-lg-8 col-xl-6">
            {(reportData?.report_type === "vibrational_frequency" ||
              ...
              reportData?.report_data?.assessment?.vibrational_frequency !=
                null) && (
              <div
                className="card mb-4"
                style={{
                      ...
                      >
                        ...
                        <Typography variant="h4" fontWeight="bold" mb={1}>
                          ...
                          <span style={{ fontSize: "0.6em" }}>
                            {location.state?.reportType?.includes("frequency")
                              ? "Hz"
                              : ""}
                          </span>
                        </Typography>
            ...
            <div className="text-center mb-4">
              ...
              >
                Discover More insights into your {displayTitle.toLowerCase()}{" "}
                and Interact to get more deeper insights
              </p>
